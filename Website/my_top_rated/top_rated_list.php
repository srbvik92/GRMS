...
$qry="select * from game_user where u_name='$uname' order by rating desc limit 10 offset 0";
...
<table width="100%" border="0">
  <tbody>
    <tr>
      ...
      <!-- Display user rating to the user -->
      <td><p>Your Rating:</p>
      <p><table width="50px" border="5" height="50" bordercolor="#FFFFFF">
  		<tbody>
    	<tr>
