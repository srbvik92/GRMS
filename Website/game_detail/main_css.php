...
<div id="game_details_summary">
<table>
	<tr>
		<td><img width="60" height="70" src=" <?php echo "images/age_rating/".$age   ?>"  /></td>
		<td valign="top">Summary : <?php echo $rw[10]; ?></td>
	</tr>
</table>
