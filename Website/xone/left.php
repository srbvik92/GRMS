...
$qry="select g_id from g_pform where xone=1 order by pc_date desc limit 5";

$rs=mysqli_query($con,$qry) or die(mysql_error($con));
?>

<table bgcolor=#000000 width="700" height="40" border="0">
	<tr>
		<td><font color="white">&nbsp;Latest XBox One Releases</font></td>
	</tr>
</table>
